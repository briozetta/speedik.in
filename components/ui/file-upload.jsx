      ...
      <motion.div
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <p
            ...
            Drag or drop your pictures here or click to upload
          </p>
          <div className="relative w-full mt-10 max-w-xl mx-auto">
              ...
              <motion.div
                ...
                className={cn(
                  "relative group-hover/file:shadow-2xl z-40 bg-emerald-600 dark:bg-neutral-900 flex items-center justify-center h-32 mt-4 w-full max-w-[8rem] mx-auto rounded-md",
                ...
                {isDragActive ? (
                  ...
                  <IconUpload className="h-8 w-8 text-neutral-100 dark:text-neutral-300" />
                )}
              </motion.div>
